...
setup(
  ...
  url = 'https://github.com/wekeypedia/toolkit-pyton', # use the URL to the github repo
  download_url = 'https://github.com/WeKeyPedia/toolkit-python/archive/0.1.0.tar.gz', # I'll explain this in a second
